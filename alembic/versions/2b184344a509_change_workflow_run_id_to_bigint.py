"""change workflow run id to bigint

Revision ID: 2b184344a509
Revises: 942d0fe2135b
Create Date: 2026-08-14 12:47:59.690016
...
revision: str = '2b184344a509'
down_revision: Union[str, None] = '942d0fe2135b'
...
def upgrade() -> None:
    ...
    op.alter_column('incidents', 'workflow_run_id',
